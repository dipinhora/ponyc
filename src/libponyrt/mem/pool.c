...
#ifdef PLATFORM_IS_X86
#define DEFAULT_CENTRAL {{NULL, 0}}
#else
#define DEFAULT_CENTRAL NULL
#endif

static pool_global_t pool_global[POOL_COUNT] =
{
  {POOL_MIN << 0, THREAD_MAX_BEFORE_SHARE(0x8000, POOL_MIN << 0),
    DEFAULT_CENTRAL},
  {POOL_MIN << 1, THREAD_MAX_BEFORE_SHARE(0x8000, POOL_MIN << 1),
    DEFAULT_CENTRAL},
  {POOL_MIN << 2, THREAD_MAX_BEFORE_SHARE(0x8000, POOL_MIN << 2),
    DEFAULT_CENTRAL},
  {POOL_MIN << 3, THREAD_MAX_BEFORE_SHARE(0x8000, POOL_MIN << 3),
    DEFAULT_CENTRAL},
  {POOL_MIN << 4, THREAD_MAX_BEFORE_SHARE(0x8000, POOL_MIN << 4),
    DEFAULT_CENTRAL},
  {POOL_MIN << 5, THREAD_MAX_BEFORE_SHARE(0x10000, POOL_MIN << 5),
    DEFAULT_CENTRAL},
  {POOL_MIN << 6, THREAD_MAX_BEFORE_SHARE(0x20000, POOL_MIN << 6),
    DEFAULT_CENTRAL},
  {POOL_MIN << 7, THREAD_MAX_BEFORE_SHARE(0x40000, POOL_MIN << 7),
    DEFAULT_CENTRAL},
  {POOL_MIN << 8, THREAD_MAX_BEFORE_SHARE(0x80000, POOL_MIN << 8),
    DEFAULT_CENTRAL},
  {POOL_MIN << 9, THREAD_MAX_BEFORE_SHARE(POOL_MAX, POOL_MIN << 9),
    DEFAULT_CENTRAL},
  {POOL_MIN << 10, THREAD_MAX_BEFORE_SHARE(POOL_MAX, POOL_MIN << 10),
    DEFAULT_CENTRAL},
  {POOL_MIN << 11, THREAD_MAX_BEFORE_SHARE(POOL_MAX, POOL_MIN << 11),
    DEFAULT_CENTRAL},
  {POOL_MIN << 12, THREAD_MAX_BEFORE_SHARE(POOL_MAX, POOL_MIN << 12),
    DEFAULT_CENTRAL},
  {POOL_MIN << 13, THREAD_MAX_BEFORE_SHARE(POOL_MAX, POOL_MIN << 13),
    DEFAULT_CENTRAL},
  {POOL_MIN << 14, THREAD_MAX_BEFORE_SHARE(POOL_MAX, POOL_MIN << 14),
    DEFAULT_CENTRAL},
  {POOL_MIN << 15, THREAD_MAX_BEFORE_SHARE(POOL_MAX, POOL_MIN << 15),
    DEFAULT_CENTRAL},
};
