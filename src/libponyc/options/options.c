...
static void usage(void)
{
  printf("%s\n%s\n%s\n%s\n%s\n%s", // for complying with -Woverlength-strings
    ...
    "                   pressure actors before a sending actor gets muted.\n"
    "                   This is used to determine the throttling factor that\n"
    "                   results in a gradual application of backpressure\n"
    "                   (actor batch size is logarithmically scaled down)\n"
    "                   ultimately resulting in muting. (max: default batch\n"
    "                   size, min: 1).\n"
    "                   Defaults to 10.\n"
